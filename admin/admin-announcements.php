...
<head>
    ...
    <style>
        ...
        .main-content { margin-left: 80px; padding: 20px; width: calc(100% - 80px); transition: margin-left 0.3s ease-in-out, width 0.3s ease-in-out; }
        ...
        .content-wrapper { display: flex; gap: 20px; align-items: flex-start; margin-top: 20px; }
        .box { flex: 1; padding: 20px; border-radius: 10px; min-height: 350px; box-shadow: 0 4px 6px rgba(0, 0, 0, 0.3); }
        .box-title { font-size: 18px; font-weight: bold; margin-bottom: 15px; text-align: center; border-bottom: 2px solid white; padding-bottom: 10px; }
        .announcement-form textarea { width: 96%; height: 200px; padding: 15px; border: none; border-radius: 5px; font-size: 16px; background-color: #212b40; color: white; resize: none; }
